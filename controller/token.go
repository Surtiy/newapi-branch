...
func setTokenGroups(c *gin.Context, token *model.Token) bool {
	...
	if err != nil { common.ApiError(c, err); return false }
	...
	token.Groups = model.NewTokenGroups(groups)
...
func AddToken(c *gin.Context) {
	...
	if token.Group == "auto" {
		...
		if !setTokenGroups(c, &token) { return }
