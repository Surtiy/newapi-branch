...
func canManageTargetRole(myRole int, targetRole int) bool {
	...
	if myRole == common.RoleBranchOperator {
		return targetRole < common.RoleAdminUser
	}
...
func calculateUserPermissions(userRole int) map[string]any {
	...
	} else if userRole == common.RoleAdminUser || userRole == common.RoleBranchOperator {
...
func generateDefaultSidebarConfig(userRole int) string {
	...
	// 管理员区域 - 根据角色决定
	if userRole == common.RoleAdminUser || userRole == common.RoleBranchOperator {
...
func CreateUser(c *gin.Context) {
	...
	myRole := c.GetInt("role")
	if myRole == common.RoleBranchOperator && user.Role >= common.RoleAdminUser {
