...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		optionRoute.Use(middleware.RootAuth())
		{
			...
			optionRoute.GET("/branch_docs", controller.GetBranchDocsConfig)
			optionRoute.PUT("/branch_docs", controller.UpdateBranchDocsConfig)
		...
		branchCatalogRoute := apiRouter.Group("/option")
		branchCatalogRoute.Use(middleware.AdminAuth())
